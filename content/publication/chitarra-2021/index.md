...
We report the rotational and vibrational investigation of two polar derivatives of adamantane (C_{10}H_{16}), 1-cyanoadamantane (C$_{10}$H$_{15}$-CN) and 1-isocyanoadamantane (C$_{10}$H$_{15}$-NC), using room temperature gas phase absorption spectroscopy. 
